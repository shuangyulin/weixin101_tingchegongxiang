<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="停车场地址" prop="tingchechangdizhi">
          <el-input v-model="ruleForm.tingchechangdizhi" 
              placeholder="停车场地址" clearable  :readonly="ro.tingchechangdizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="停车场地址" prop="tingchechangdizhi">
              <el-input v-model="ruleForm.tingchechangdizhi" 
                placeholder="停车场地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="车位数量" prop="cheweishuliang">
          <el-input v-model="ruleForm.cheweishuliang" 
              placeholder="车位数量" clearable  :readonly="ro.cheweishuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="车位数量" prop="cheweishuliang">
              <el-input v-model="ruleForm.cheweishuliang" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="停车费" prop="tingchefei">
          <el-input v-model="ruleForm.tingchefei" 
              placeholder="停车费" clearable  :readonly="ro.tingchefei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="停车费" prop="tingchefei">
              <el-input v-model="ruleForm.tingchefei" 
                placeholder="停车费" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="停车场介绍" prop="tingchechangjieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.tingchechangjieshao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.tingchechangjieshao" label="停车场介绍" prop="tingchechangjieshao">
                    <span v-html="ruleForm.tingchechangjieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.tingchechangjieshao = this.ruleForm.tingchechangjieshao.replace(reg,'../../../ssm5mk75/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
